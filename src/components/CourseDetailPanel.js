...
export default function CourseDetailPanel() {
  ...
  return (
    <Box style={{position:'fixed', display:'flex', flexDirection:'column', bottom:0, left: '50%', transform: 'translateX(-50%)', width:'98vw', height:'25vh', justifyContent:'center'}}>
      ...
      <Box style={{display:'flex', flex:'1', bottom:0, width:'100%', height:'100%',  borderRadius:'5px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.2)', backgroundColor:'white'}}>
        <Box style={{display:'flex', flexDirection:'column', justifyContent:'flex-end', flex:1, margin:4}}>
          <Box style={{flex: '0'}}>
