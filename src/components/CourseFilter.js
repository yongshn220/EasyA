...
export default function CourseFilter() {
  ...
  return (
    <Box onClick={() => {setToggleFilter(!toggleFilter)}} style={{display:'flex', flexDirection:'column', flex:'1', marginLeft:40, marginRight:40, padding:'20px', borderRadius:'5px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', backgroundColor:'rgba(255, 255, 255, 0.2)'}}>
      {
        toggleFilter === false?
